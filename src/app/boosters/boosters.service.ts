...
export class BoostersService extends BaseApi {
  ...
  getData() {
    ...
    return this.getWithHeadersAndParams(`/boosters/`, headers);
  }

  postData(data) {
    let headers = new HttpHeaders();
    headers = headers.append('x-api-token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..zJJ4SOJ1Zn73yd-iLkj5cwI5rb5jKXVw2A2Y-2KcZ6I');
    return this.postWithHeadersAndParams(`/boosters/`, data, headers);
  }
  ...
  postImg(id, data) {
    ...
    return this.postImage(`/boosters/${id}`, formData, headers);
  }

  editData(id, data) {
    let headers = new HttpHeaders();
    headers = headers.append('x-api-token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..zJJ4SOJ1Zn73yd-iLkj5cwI5rb5jKXVw2A2Y-2KcZ6I');
    return this.putWithHeadersAndParams(`/boosters/${id}`, data, headers);
  }

  deleteData(id) {
    let headers = new HttpHeaders();
    headers = headers.append('x-api-token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..zJJ4SOJ1Zn73yd-iLkj5cwI5rb5jKXVw2A2Y-2KcZ6I');
    return this.deleteWithHeadersAndParams(`/boosters/${id}`, headers);
  }
}
